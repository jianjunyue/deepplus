if __name__ == '__main__':
    ...
    from temp.recommend.algorithm.RippleNet.tool import get_user_positive_item_list, construct_directed_kg, get_ripple_set
    from temp.recommend.algorithm.RippleNet.model import RippleNet_model
    from temp.recommend.algorithm.RippleNet.train import train
