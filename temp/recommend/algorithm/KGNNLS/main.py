if __name__ == '__main__':
    ...
    from temp.recommend.algorithm.KGCN.tool import construct_undirected_kg, get_adj_list
    from temp.recommend.algorithm.KGCN.model import KGCN_model
    from temp.recommend.algorithm.KGCN.train import train
    from temp.recommend.algorithm.KGNNLS.tool import get_interaction_table
    from temp.recommend.algorithm.KGNNLS.model import KGNNLS_model
    from temp.recommend.data import kg_loader, data_process
